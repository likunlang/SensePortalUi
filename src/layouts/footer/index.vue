<template>
  <div id="contact_us" class="relative flex flex-row items-center text-lg font-regular bg-dark-500 md:flex-col px-10 py-20 sm:p-4 md:px-8 md:py-10">
    <div class="w-full text-center">
      <div class="md:mb-10 mb-8 flex justify-between items-center footer-box">
        ...
        <a class="hover:no-underline shrink-0 text-white/80 cursor-pointer">
          ...
          Add:Bucuresti  Sectorul 6. Aleea DEALUL MÃCINULUl.Nr.1A.camera 1.Bloc 452.Scara D.Etaj 7. Ap. 164.
        </a>
      </div>
