...
export default [
  ...
  },
  {
    ...
    description: "As the penetration of new energy vehicles (especially pure electric vehicles) continues to rise in 2025, many owners are discovering that the most pleasant surprise after purchasing a car isn't the fast acceleration or quiet operation, but the surprisingly low maintenance costs. Multiple authoritative data sources indicate that the annual maintenance costs for new energy vehicles are often only one-third to one-half of those for traditional fuel vehicles, or even lower. Why is there such a significant difference? This article explains the reasons from three perspectives: structural differences, specific item comparisons, and real-world data.",
