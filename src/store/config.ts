...
export const bannerListData = [
  {
    title: 'V9',
    img: CDN_URL + '/resource/images/banner_V9.webp',
    docUrl: CDN_URL + '/resource/doc/E_STAR_V9.pdf',
    videoUrl: CDN_URL + '/resource/video/V9.mp4',
    content: '',
  },
  {
    title: 'T',
    img: CDN_URL + '/resource/images/banner_T.webp',
    docUrl: CDN_URL + '/resource/doc/E_STAR_T.pdf',
    videoUrl: CDN_URL + '/resource/video/T.mp4',
    content: '',
  },
  {
    title: 'V5',
    img: CDN_URL + '/resource/images/banner_V5.webp',
    docUrl: CDN_URL + '/resource/doc/E_STAR_V5.pdf',
    videoUrl: CDN_URL + '/resource/video/V5.mp4',
    content: '',
  },
  {
    title: 'G050',
    img: CDN_URL + '/resource/images/banner_G050.webp',
    docUrl: CDN_URL + '/resource/doc/G050-L.pdf',
    docUrl1: CDN_URL + '/resource/doc/G050P-L.pdf',
    videoUrl: CDN_URL + '/resource/video/G050.mp4',
    content: '',
  },
  {
    title: 'G105',
    img: CDN_URL + '/resource/images/banner_G105.webp',
